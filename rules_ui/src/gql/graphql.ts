...
export type AllReviewRulesQueryQuery = { __typename?: 'Query', rules: Array<(
    { __typename?: 'ReviewRule', id: string, successCount: number, failureCount: number, trigger: { __typename?: 'ReviewTrigger', triggerName: string }, condition: { __typename?: 'ReviewCondition', property: string, value?: string | null }, effect: { __typename?: 'ReviewEffect', name: string } }
